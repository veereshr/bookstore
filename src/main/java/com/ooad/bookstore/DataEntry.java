...
public class DataEntry extends JFrame {
	...
	public DataEntry(final String userName, String type) {
		if (type.equalsIgnoreCase("add")) {
			...
			lblAvailability.setFont(new Font("Calibri",
			...
			btnSave.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					try{
						...
						if(bookName.length()>20 || bookType.length()>20 || availability.length()>20 || price.length()>20 || ISBN.length()>20
								){
						...
						JOptionPane.showMessageDialog(null,
								"Length of any of these fields shouldn't exceed 20");
					}
					catch (NumberFormatException exception) {
						JOptionPane.showMessageDialog(null,
								"Please enter numbers for availability and price");
					}
				}
			...
			btnSave.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					try{
						...
						if(bookName.length()>20 || bookType.length()>20 || availability.length()>20 || price.length()>20 || ISBNstr.length()>20
								){
							throw new InputMismatchException();
						}
						Integer.parseInt(availability);
						Integer.parseInt(price);
						if (updateBook(bookName, bookType, availability, price, ISBNstr) == DBUtilitiesDAOImpl.SUCCESS) {
							JOptionPane.showMessageDialog(null,
	...
	protected int updateBook(String bookName, String bookType,
