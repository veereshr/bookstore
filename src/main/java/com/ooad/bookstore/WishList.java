...
public class WishList extends JFrame {
	...
	public WishList() {
		...
		JButton btnRemoveWishlist = new JButton("Remove Wishlist");
		btnRemoveWishlist.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {

			}
		});
		btnRemoveWishlist.setFont(new Font("Calibri", Font.BOLD, 18));
		btnRemoveWishlist.setBackground(Color.CYAN);
										...
										groupLayoutJContentPane.createSequentialGroup().addGroup(groupLayoutJContentPane
												...
												.addGroup(groupLayoutJContentPane.createParallelGroup(Alignment.LEADING)
														.addComponent(btnLogout, GroupLayout.PREFERRED_SIZE, 160,
																GroupLayout.PREFERRED_SIZE)
														.addComponent(btnRemoveWishlist, GroupLayout.PREFERRED_SIZE,
		...
		groupLayoutJContentPane.setVerticalGroup(groupLayoutJContentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayoutJContentPane.createSequentialGroup().addGap(4)
						...
						.addGroup(groupLayoutJContentPane.createParallelGroup(Alignment.LEADING)
								.addGroup(groupLayoutJContentPane.createSequentialGroup().addGap(127)
										.addComponent(btnContinueShopping, GroupLayout.PREFERRED_SIZE, 38,
												GroupLayout.PREFERRED_SIZE)
										.addGap(18)
										.addComponent(btnRemoveWishlist, GroupLayout.PREFERRED_SIZE, 38,
												GroupLayout.PREFERRED_SIZE)
										.addGap(18).addComponent(btnLogout, GroupLayout.PREFERRED_SIZE, 38,
												GroupLayout.PREFERRED_SIZE))
